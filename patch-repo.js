...
const repoFile = 'server/db/release-repository.ts';
let content = fs.readFileSync(repoFile, 'utf8');

const bulkUpsertCode = 
...
content = content.replace("async query(query: ReleaseQuery)", bulkUpsertCode + "\n  async query(query: ReleaseQuery)");
