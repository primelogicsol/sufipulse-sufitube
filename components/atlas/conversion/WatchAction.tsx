...
export function WatchAction({ videoId, title = 'Watch on YouTube' }: WatchActionProps) {
  return (
    <a 
    ...
    >
      <div className="flex items-center space-x-4">
        <div className="w-12 h-12 rounded-full bg-red-500/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
          <PlayCircle className="w-6 h-6 text-red-500" />
        </div>
        <div>
          <p className="text-sm font-medium text-emerald-500 mb-1">Watch Video</p>
