...
let leads = ['Zayan Ali', 'Avtar Singh'];
let bgs = ['Zohair Shah', 'Saifullah'];
...
// Update Release 28
let r = releases.find(x => x.youtubeId === 'jV-f1b_qSYU');
if (r) {
    r.canonicalTitle = 'Khaaki Banda | Satrangi | Manrangi | Zaat Magar Faani Teri | SufiPulse USA';
    ...
    if (!r.releaseRights.registeredReleaseId && !r.registeredReleaseId) {
        r.releaseRights.registeredReleaseId = 'SP-KS-2025-028';
    }
    
    r.releaseDate = '2025-11-07';
    r.releaseRights.releaseDate = '2025-11-07';
