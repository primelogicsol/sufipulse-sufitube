...
let leads = ['Isaiah Cole'];
let bgs = ['Taylor Reyes', 'Jordan Ellis'];
...
// Update Release 36
let r = releases.find(x => x.youtubeId === 'Aa-T-aA3kpk');
if (r) {
    r.canonicalTitle = 'New Age Sufi on Highway to Haqq | SufiPulse USA';
    ...
    if (!r.releaseRights.registeredReleaseId && !r.registeredReleaseId) {
        r.releaseRights.registeredReleaseId = 'SP-KS-2025-036';
    }
    
    r.releaseDate = '2025-06-09';
    r.releaseRights.releaseDate = '2025-06-09';
