...
let leads = ['Isaiah Cole', 'Amara Rose'];
...
// Update Release 32
let r = releases.find(x => x.youtubeId === 'tFpnzwapo1A');
if (r) {
    r.canonicalTitle = 'Sultan | The Spiritual King of Kashmir | SufiPulse USA';
    ...
    if (!r.releaseRights.registeredReleaseId && !r.registeredReleaseId) {
        r.releaseRights.registeredReleaseId = 'SP-KS-2025-032';
    }
    
    r.releaseDate = '2025-05-24';
    r.releaseRights.releaseDate = '2025-05-24';
