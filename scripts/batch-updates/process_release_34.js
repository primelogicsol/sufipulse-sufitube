...
// Update Release 34
let r = releases.find(x => x.youtubeId === '8yL--I2zeDE');
if (r) {
    r.canonicalTitle = 'I Am Sufi, I Am You | Interfaith Sufi Song';
    ...
    if (!r.releaseRights.registeredReleaseId && !r.registeredReleaseId) {
        ...
        r.releaseRights.registeredReleaseId = `SP-KS-${year}-034`;
    }
