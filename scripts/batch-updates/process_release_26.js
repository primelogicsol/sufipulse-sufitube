...
let leads = ['Zaryab Qadri', 'Sajjad Noorani', 'Mehran Sajjad'];
let bgs = ['Usman Fida', 'Naeem Khwaja', 'Saif Ubaidi', 'Arif Noor', 'Talha Nizami', 'Kamran Sabri'];
let allVocals = new Set([...leads, ...bgs]);
...
// Update Release 26
let r = releases.find(x => x.youtubeId === 'vKVAKJgOa5I');
if (r) {
    r.canonicalTitle = 'Ya Ghaus-ul-Azam | Madad Ban Kar Aaja | Come as My Helper | SufiPulse USA';
    ...
    if (!r.releaseRights.registeredReleaseId && !r.registeredReleaseId) {
        r.releaseRights.registeredReleaseId = 'SP-KS-2025-026';
    }
    
    r.releaseDate = '2025-11-23';
    r.releaseRights.releaseDate = '2025-11-23';
