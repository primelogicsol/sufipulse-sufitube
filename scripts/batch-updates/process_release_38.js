...
let leads = ['David Matthews', 'Emily Harper'];
...
// Update Release 38
let r = releases.find(x => x.youtubeId === 'U6uT9yaQy0Y');
if (r) {
    r.canonicalTitle = 'Let Mansur Speak | SufiPulse USA';
    ...
    if (!r.releaseRights.registeredReleaseId && !r.registeredReleaseId) {
        r.releaseRights.registeredReleaseId = 'SP-KS-2025-038';
    }
