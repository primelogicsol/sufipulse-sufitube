...
let leads = ['Nicholas Ryan Gant'];
let bgs = ['Derrick Leon Gray'];
...
for (let name of allVocals) {
    ...
    if (!v) {
        v = {
            ...
            identity_type: 'STUDIO_PSEUDONYM', // we'll use standard unless noted otherwise
...
// Update Release 30
let r = releases.find(x => x.youtubeId === 'a1wCTXlmlb4');
if (r) {
    r.canonicalTitle = 'I Am Kashmiri Sufi | The Saints Still Walk | SufiPulse USA';
    ...
    if (!r.releaseRights.registeredReleaseId && !r.registeredReleaseId) {
        r.releaseRights.registeredReleaseId = 'SP-KS-2025-030';
    }
    
    r.releaseDate = '2025-05-21';
    r.releaseRights.releaseDate = '2025-05-21';
