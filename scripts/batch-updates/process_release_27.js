...
// Update Release 27
let r = releases.find(x => x.youtubeId === 'BFG-8G3-thY');
if (r) {
    r.canonicalTitle = 'Main Habba Hoon | Meri Kahani Dilon Mein Hai, Kagazon Mein Nahi | SufiPulse USA';
    ...
    if (!r.releaseRights.registeredReleaseId && !r.registeredReleaseId) {
        r.releaseRights.registeredReleaseId = 'SP-KS-2025-027';
    }
    
    r.releaseDate = '2025-11-11';
    r.releaseRights.releaseDate = '2025-11-11';
