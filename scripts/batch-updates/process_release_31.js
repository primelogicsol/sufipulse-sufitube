...
let leads = ['Sarah Thompson', 'Michael Thompson'];
...
// Update Release 31
let r = releases.find(x => x.youtubeId === 'ZtI5T0H0nnY');
if (r) {
    r.canonicalTitle = 'Seeker to Sufi | Divine Homecoming | SufiPulse USA';
    ...
    r.publicCredits.artistic.backgroundVocals = ''; // explicitly empty for now
    ...
    if (!r.releaseRights.registeredReleaseId && !r.registeredReleaseId) {
        r.releaseRights.registeredReleaseId = 'SP-KS-2025-031';
    }
    
    r.releaseDate = '2025-05-23';
    r.releaseRights.releaseDate = '2025-05-23';
