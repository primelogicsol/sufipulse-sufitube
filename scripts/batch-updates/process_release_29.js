...
let leads = ['Imran Shafeeq', 'Huzaifa Mirza', 'Zarrar Ali'];
let bgs = ['Adeel Farooqi', 'Shahbaz Rehmani', 'Samiullah Dar', 'Fahad Nizami'];
...
// Update Release 29
let r = releases.find(x => x.youtubeId === 'zFD8rHYcx-w');
if (r) {
    r.canonicalTitle = 'Agar Mohammad ﷺ Na Hotay | Subtitled in 17 Languages | SufiPulse USA';
    ...
    if (!r.releaseRights.registeredReleaseId && !r.registeredReleaseId) {
        r.releaseRights.registeredReleaseId = 'SP-KS-2025-029';
    }
    
    r.releaseDate = '2025-10-16';
    r.releaseRights.releaseDate = '2025-10-16';
