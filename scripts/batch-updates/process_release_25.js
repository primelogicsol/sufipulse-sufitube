...
let leads = ['Maazin Khalid', 'Rauf Azeem'];
let bgs = ['Dr. Zarf-e-Noori'];
...
// Update Release 25
let r = releases.find(x => x.youtubeId === 'be6GFwGpobw');
if (r) {
    r.canonicalTitle = 'Needle to Noor | Saada-e-Najaat | Voice for Those Facing Addiction | SufiPulse USA';
    ...
    if (!r.releaseRights.registeredReleaseId && !r.registeredReleaseId) {
        r.releaseRights.registeredReleaseId = 'SP-KS-2025-025';
    }
    
    r.releaseDate = '2025-11-28';
    r.releaseRights.releaseDate = '2025-11-28';
