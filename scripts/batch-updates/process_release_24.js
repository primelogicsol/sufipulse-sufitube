...
let leads = ['Armaan Qadri', 'Sameer Nizami', 'Yusuf Rahmani'];
let bgs = ['Ayaan Mir', 'Rahib Dar', 'Nisar Farooqi', 'Fahad Zameer', 'Zayan Raza', 'Meher Gulzar'];
...
// Update Release 24
let r = releases.find(x => x.youtubeId === 'LwnPXSEJJHI');
if (r) {
    r.canonicalTitle = 'Sufi Hacker | Dil Ka Code Reader | For Developers & Thinkers | SufiPulse USA';
    ...
    if (!r.releaseRights.registeredReleaseId && !r.registeredReleaseId) {
        r.releaseRights.registeredReleaseId = 'SP-KS-2025-024';
    }
    
    r.releaseDate = '2025-12-09';
    r.releaseRights.releaseDate = '2025-12-09';
