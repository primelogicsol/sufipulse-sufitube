...
let bgs = ['Ruqayya Basit', 'Fatima Meher', 'Samina Jaleel'];
...
let r = releases.find(x => x.youtubeId === 'gtT_l6AH7Rc');
if (r) {
    r.canonicalTitle = 'Ya Ali, Ya Ali, Ya Ali | When the Soul Calls Its Master | SufiPulse USA';
    
    if (!r.publicCredits) r.publicCredits = {};
    if (!r.publicCredits.artistic) r.publicCredits.artistic = {};
    r.publicCredits.artistic.leadVocalist = 'Layla Feroze, Amir Haider';
