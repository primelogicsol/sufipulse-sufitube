...
// Update Release 33
let r = releases.find(x => x.youtubeId === 'I1b9QtSmRAQ');
if (r) {
    r.canonicalTitle = 'Dr. Kumar Faqeer | Kashmir Calling Me | SufiPulse USA';
    ...
    if (!r.releaseRights.registeredReleaseId && !r.registeredReleaseId) {
        r.releaseRights.registeredReleaseId = 'SP-KS-2025-033';
    }
