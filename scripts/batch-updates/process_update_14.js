...
let bgs = ['Shae Gill', 'Aima Baig', 'Yusuf Anwar', 'Zuhair Qasim', 'Dr. Zarf-e-Noori'];
...
let r = releases.find(x => x.youtubeId === 'UcV7rMQ7XGg');
if (r) {
    r.canonicalTitle = 'Phir Likh Zarf-e-Noori | Faith Does Not Fear Critics | SufiPulse USA';
    
    if (!r.publicCredits) r.publicCredits = {};
    if (!r.publicCredits.artistic) r.publicCredits.artistic = {};
    r.publicCredits.artistic.leadVocalist = 'Kaifi Khalil, Talha Anjum, Abdul Hannan, Asim Azhar';
