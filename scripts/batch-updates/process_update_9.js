...
let bgs = ['Aditya', 'Vedant', 'Raghav Aarav', 'Dr. Zarf-e-Noori'];
...
let r = releases.find(x => x.youtubeId === 'dXqkrpP-41I');
if (r) {
    r.canonicalTitle = 'PANI GAWAH HAI | KASHMIR WATER BEARS WITNESS | SufiPulse USA';
    
    if (!r.publicCredits) r.publicCredits = {};
    if (!r.publicCredits.artistic) r.publicCredits.artistic = {};
    r.publicCredits.artistic.leadVocalist = 'Neel Madhav, Arin Kashyap';
    r.publicCredits.artistic.backgroundVocals = bgs.join(', ');

    r.releaseDate = '2026-07-24';
    if (r.releaseRights) {
        r.releaseRights.releaseDate = '2026-07-24';
    }
