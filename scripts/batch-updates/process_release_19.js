...
const newNames = ['Ibrahim Ziya', 'Amina Noor', 'Faizan Rahim'];
...
const ytId = 'lMxb4Dk-n0Y';
const newTitle = 'Ya Dost | Asma Se Qalb Tak | Divine Names & Responsibility | SufiPulse USA';
const voc = 'Ibrahim Ziya, Amina Noor, Faizan Rahim';
...
if (!r) {
  ...
  if (!r.releaseRights.registeredReleaseId && !r.registeredReleaseId) {
      r.releaseRights.registeredReleaseId = 'SP-KS-2026-019';
  }
  
  r.releaseDate = '2026-01-11';
  r.releaseRights.releaseDate = '2026-01-11';
