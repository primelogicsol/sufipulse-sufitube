const { entityCreate, entityGetAll } = require('./lib/entity-storage-server');

const existing = entityGetAll('writers').find(w => w.name === 'Dr. Zarf-e-Noori' || w.public_name === 'Dr. Zarf-e-Noori');
if (!existing) {
