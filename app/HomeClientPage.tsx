...
export default function Home({ initialReleaseCount }: { initialReleaseCount?: number }) {
  ...
  // Release count is SSR-injected from the canonical release store — no hardcode, no stale value.
  const [kpiStats, setKpiStats] = useState({
    releases: initialReleaseCount ?? 0,
    writers: literaryArticles.length,
    institutions: 4,
  });
