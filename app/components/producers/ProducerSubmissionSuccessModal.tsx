...
export function ProducerSubmissionSuccessModal({ onClose, submissionId }: ProducerSubmissionSuccessModalProps) {
      ...
      <div className="modal-card" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-[#D4AF37] text-sm font-medium tracking-wider uppercase mb-6">
            Ahl-e-Naghma Production Review Queue
          </p>
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="p-5 bg-white/[0.02] border border-white/10 rounded-xl">
            <p className="text-[var(--color-text-secondary)] leading-relaxed">
              All submissions undergo institutional review for musical competence, technical capability, and governance alignment.
            </p>
          </div>
        ...
        <div className="mb-8">
          ...
          <ul className="space-y-3 text-sm text-[var(--color-text-secondary)]">
            <li className="flex items-start gap-3">
              ...
              <span>Portfolio and competency review begins</span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>You may be asked to provide additional production samples</span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>Upon approval, production assignment access will activate</span>
            </li>
            <li className="flex items-start gap-3">
