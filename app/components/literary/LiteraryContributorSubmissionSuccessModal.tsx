...
export function LiteraryContributorSubmissionSuccessModal({ 
  onClose, 
  submissionId,
  trackingToken 
}: SuccessModalProps) {
      ...
      <div className="relative w-full max-w-2xl bg-[#0a0a0a] border border-amber-400/20 rounded-[32px] shadow-[0_0_100px_rgba(251,191,36,0.1)] overflow-hidden animate-in fade-in zoom-in duration-500">
        ...
        <div className="relative h-48 flex items-center justify-center bg-linear-to-b from-amber-400/10 to-transparent">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-amber-400">Institutional Intake Authorized</p>
          </div>
        </div>
        ...
        <div className="px-10 pb-12">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 tracking-tight">Ahl-e-Tahreer Application Submitted</h2>
            <p className="text-neutral-400 text-sm leading-relaxed max-w-md mx-auto">
              Your Literary Contributor application has been received for editorial review under Ahl-e-Tahreer. Approved work may be considered for the SufiPulse Literary Journal.
            </p>
          </div>
          ...
          <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-6 mb-10 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="text-right md:text-right w-full md:w-auto">
              <p className="text-[10px] font-black text-neutral-500 uppercase tracking-widest mb-1">Authorization Status</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
            <div className="p-5 rounded-2xl border border-white/5 bg-white/[0.01]">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="text-[11px] font-black text-white uppercase tracking-widest leading-none mt-0.5">Editorial Review</h4>
              </div>
              <p className="text-[10px] text-neutral-500 leading-relaxed uppercase tracking-wider">
                Our board will assess your linguistic profile and sample against institutional standards.
              </p>
            </div>
            <div className="p-5 rounded-2xl border border-white/5 bg-white/[0.01]">
              <div className="flex items-center gap-3 mb-3">
                <BookOpen size={16} className="text-amber-400" />
                <h4 className="text-[11px] font-black text-white uppercase tracking-widest leading-none mt-0.5">Journal Consideration</h4>
              </div>
              <p className="text-[10px] text-neutral-500 leading-relaxed uppercase tracking-wider">
                Approved work enters the literary queue for potential publication in the Journal.
              </p>
            </div>
          </div>
