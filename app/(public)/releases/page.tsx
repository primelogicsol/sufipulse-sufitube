...
import { getBestReleaseDate, sortReleases, cleanDisplayTitle, getCanonicalTitle, getYoutubeTitle, resolveFlagshipRelease } from '@/lib/release-utils';
import { canAccessAdmin } from '@/app/lib/role-access';
import { StudioGovernancePanel } from '../../components/studio/StudioLayoutComponents';
import { FlagshipSpotlight } from '@/app/components/releases/FlagshipSpotlight';
...
export default function Releases() {
    ...
    // Featured flagship: single canonical selection logic
    const featuredRelease = useMemo(() => resolveFlagshipRelease(releases || []), [releases]);
    ...
    return (
        <>
                ...
                <div className="relative z-10">
                    <PageContainer>
                        <div className="max-w-5xl mx-auto text-center">
                            ...
                            <div className="mb-14">
                                <HeroCTAGroup 
                                    primary={{ label: "Explore Catalogue", href: "#browse-releases", icon: <Disc3 className="w-4 h-4" /> }}
                                    secondary={{ label: "Official Channels & Radio", href: "/official-channels", icon: <Radio className="w-4 h-4 text-[var(--color-gold)]" /> }}
                                />
                            </div>
            ...
            <FlagshipSpotlight featuredRelease={featuredRelease} />
                                                ...
                                                <div className="p-5 flex flex-col gap-5">
                                                    ...
                                                    <div className="flex items-center justify-between text-[11px] text-white/40 font-bold uppercase tracking-wider mt-1">
                                                        <div className="flex items-center gap-4">
                                                            <span>{new Date(release.publishedDate || new Date().toISOString()).toLocaleDateString('en-US', { month: 'short', year: 'numeric' })}</span>
