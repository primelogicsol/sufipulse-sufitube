    ...
    <div className="max-w-3xl mx-auto py-12">
      <div className="text-center mb-16">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tighter">
          Performance Profile Authorized
        </h1>
        <p className="text-neutral-500 text-lg max-w-xl mx-auto leading-relaxed">
          Your vocalist application has been formally logged into the Ahl-e-Sada registry. Secure tracking is now active.
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="space-y-4">
              ...
              <p className="text-[11px] text-neutral-500 leading-relaxed uppercase tracking-wider">
                Technical evaluation and range screening typically occurs within 7–14 business days.
              </p>
            </div>
            <div className="space-y-4">
              ...
              <p className="text-[11px] text-neutral-500 leading-relaxed uppercase tracking-wider">
                You will receive secure notifications for every technical milestone and editorial decision.
              </p>
            </div>
            <div className="space-y-4">
              ...
              <p className="text-[11px] text-neutral-500 leading-relaxed uppercase tracking-wider">
                Upon approval, your Performance Dashboard will be unlocked for kalam assignment.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="text-center">
        <p className="text-[10px] text-neutral-600 uppercase font-black tracking-widest mb-8">
          Submission acknowledgment does not constitute recording authorization or release clearance.
        </p>
        <Link href="/vocalists">
