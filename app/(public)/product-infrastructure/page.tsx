  ...
  return (
    <Layout>
      <StudioHero 
        ...
        mysticalName="System Foundations & Technical Strategy"
        description="SufiPulse is built on a principled technical foundation — file-first, privacy-respecting, and open to ethical infrastructure partners aligned with our mission."
      />
      ...
      <Section background="midnight" spacing="normal">
        <PageContainer>
          <div className="max-w-4xl mx-auto text-center mb-10 md:mb-16">
            <h2 className="text-2xl md:text-4xl font-bold text-white mb-4 md:mb-6 tracking-tight">Infrastructure Partnership</h2>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="elite-card overflow-hidden shadow-2xl">
                <div className="border-b border-white/5 px-6 md:px-8 py-6 md:py-8 bg-white/[0.02]">
                    <h3 className="text-xl md:text-2xl font-bold text-white mb-2 tracking-tight">Infrastructure Proposal</h3>
                ...
                {submitted ? (
                    <div className="p-8 md:p-16 text-center animate-in fade-in zoom-in duration-700">
                        ...
                        <h3 className="text-2xl md:text-3xl font-bold text-white mb-3 md:mb-4 tracking-tight">Proposal Received</h3>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 md:p-10 lg:p-16 space-y-8 md:space-y-12">
                        <div className="space-y-6 md:space-y-8">
                            <p className="text-[9px] text-neutral-600 font-black uppercase tracking-[0.4em] mb-3 md:mb-4 border-b border-white/5 pb-3 md:pb-4">01 — Technical Contact</p>
                        ...
                        <div className="space-y-6 md:space-y-8">
                            <p className="text-[9px] text-neutral-600 font-black uppercase tracking-[0.4em] mb-3 md:mb-4 border-b border-white/5 pb-3 md:pb-4">02 — Partnership Scope</p>
                            <div className="grid md:grid-cols-2 gap-4 md:gap-8">
                        ...
                        <div className="space-y-6 md:space-y-8">
                            <p className="text-[9px] text-neutral-600 font-black uppercase tracking-[0.4em] mb-3 md:mb-4 border-b border-white/5 pb-3 md:pb-4">03 — Technical Specifications</p>
                            <div className="space-y-6 md:space-y-8">
                                <div className="space-y-2 group">
                                    <label className="text-[9px] md:text-[10px] font-black text-neutral-500 uppercase tracking-widest ml-1 transition-colors group-focus-within:text-amber-400">Technical Description</label>
                                    <textarea
                                ...
                                <div className="space-y-2 group">
                                    <label className="text-[9px] md:text-[10px] font-black text-neutral-500 uppercase tracking-widest ml-1 transition-colors group-focus-within:text-amber-400">Integration Scope</label>
                                    <textarea
                                ...
                                <div className="grid md:grid-cols-2 gap-4 md:gap-8">
                                    <div className="space-y-2 group">
                                        <label className="text-[9px] md:text-[10px] font-black text-neutral-500 uppercase tracking-widest ml-1 transition-colors group-focus-within:text-amber-400">Compliance & Privacy</label>
                                        <textarea
                                    ...
                                    <div className="space-y-2 group">
                                        <label className="text-[9px] md:text-[10px] font-black text-neutral-500 uppercase tracking-widest ml-1 transition-colors group-focus-within:text-amber-400">Proposed Timeline</label>
                                        <textarea
                                            name="timeline"
                        ...
                        <div className="pt-4 md:pt-6">
                            ...
                            >
                                {submitting ? <Loader2 className="w-5 h-5 md:w-6 md:h-6 animate-spin text-black" /> : <ShieldCheck size={20} className="md:size-[24px] group-hover:scale-110 transition-transform" />}
